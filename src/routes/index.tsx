...
function Homepage() {
  ...
  return (
    <>
      <div className='font-corbel mt-10'>
        <div className='flex gap-5 items-center justify-center'>
          ...
          <div className='text-center flex flex-col gap-4'>
            <div>
              <h1 className='text-2xl text-nowrap md:text-4xl font-bold tracking-widest'>ULASAN-LIAR.COM</h1>
              <h1 className='text-sm'>Ulas apa saja, kritik dan saran terbuka untuk siapapun</h1>
            </div>
      ...
      <div className='flex justify-center gap-2 md:gap-4 font-corbel'>
      ...
      <div className='flex justify-center font-corbel'>
        <div className='bg-indigo-200 h-fit w-[350px] md:w-[500px] mt-10 p-5 border-b-4 border-b-black border-l-4 border-l-black flex flex-col gap-4'>
          <p className='text-sm md:text-md'><span className='font-bold'>ulasan-liar.com</span> membantu publikasi ulasan terhadap segala sesuatu.</p>
          <div className='flex text-sm items-center'>
            ...
            <div className='overflow-hidden max-w-[100px] md:max-w-[150px]'>
              <img src="panduan-main-page.png" alt="" />
            </div>
          </div>
          <p className='text-sm md:text-md'>Jadilah <Link to='/buat-objek' className='font-bold text-blue-500 underline hover:no-underline' >kontributor</Link> agar semakin banyak objek yang bisa diulas secara publik. Biarkan publik menilai.</p>
        </div>
      </div>
